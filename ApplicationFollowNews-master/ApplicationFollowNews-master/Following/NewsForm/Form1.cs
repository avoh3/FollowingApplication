...
namespace NewsForm
{
...

    {
        ...
        {
            using (var db = new MyUsersEntities())
            {
        ...
        int pagenumber;
        string pin, password;
        static string path = Environment.GetFolderPath(Environment.SpecialFolder.Desktop) + "\\Armsport.html";
        string email, name;
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            var task = Task.Run(() =>
            {
                ...
                MyNews mn = new MyNews("Armsport",selected.ToString());
